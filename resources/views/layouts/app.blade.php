                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        @else
                            ...
                            <li class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdown">
                                    <a class="dropdown-item" href="{{ route('ingridient.index') }}">
                                        Ingridients List
                                    </a>
                                        <a class="dropdown-item" href="{{ route('ingridient.create') }}">
                                        New Ingridient
                                    </a>
                                </div>
                            </li>
                ...
                <div class="row justify-content-center">
                    <div class="col-12">
                        ...
                        @if (session()->has('info_message'))
                            <div class="alert alert-danger" role="alert">{{session()->get('info_message')}}</div>
                        @endif
                    </div>
                </div>
            </div>
